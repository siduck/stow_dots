...
static const int vertpadtab         = 11;       /* vertical padding of the tab bar, same meaning as vertpadbar */
static const int gaptab             = 4;        /* gap around the tab bar, both above and below it */
...
static const char *colors[][3]      = {
    ...
    [TabSel]           = { white,   gray1,  black },
    [TabNorm]          = { grey_fg,   black,  black },
